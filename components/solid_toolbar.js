...
export default class SolidToolbar extends Component {
    ...
    render() {
        console.log(this.props.navigator_tb)
        return (
            
                <View data-layer="4fbdb403-adb0-419b-a8f3-64d34f51e79d" style={[styles.profile_toolbartransparent,styles.readarticle_toolbar_rectangle14]}>
                    {/* <View style={[styles.readarticle_toolbar, styles.readarticle_toolbar_rectangle14]}/> */}
                    ...
                    <TouchableOpacity onPress={() => this.props.navigator_tb.push("Transfer")}>
                        <Image style={styles.wallet_icon} source={require('../assets/wallet.png')}  />
                    </TouchableOpacity>
...
SolidToolbar.propTypes = {

}

SolidToolbar.defaultProps = {
...
const styles = StyleSheet.create({
    ...
    "readarticle_toolbar_rectangle14": {
        "opacity": 1,
        // "position": "absolute",
